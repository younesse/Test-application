package com.news.feed.repository;

import com.news.feed.AppApp;
import com.news.feed.config.Constants;
import com.news.feed.config.audit.AuditEventConverter;
import com.news.feed.domain.PersistentAuditEvent;
...
import static com.news.feed.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
